...
weft worktree mirrors host subpaths. The package now exposes a farewell composer
alongside the greeting one. This is *not* an invitation to run `lyx` from that
